...
Developed for STAT 181 (Statistical Computing) at the Institute of Statistics, UP Los Banos.
...
- ✅ **Rich visualizations** including distributions, Q-Q plots, and confidence intervals
...
These match R's built-in functions to **4 decimal places** (validated by 360+ tests).
...
- **Non-normal data**: Use `bootstrap_ttest()` for non-parametric inference
